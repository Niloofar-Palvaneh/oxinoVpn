            ...
            <div className=" flex items-center justify-center bg-white z-10">
                <div className="w-[81%] border rounded mt-12 pb-6 relative sm:w-full">
                    <div className="bg-gray-100 border-b text-xl p-4">
                        <h4>آموزش استفاده در اندروید</h4>
                    </div>
                    ...
                    <div className="text-yellow-900 bg-yellow-100 flex items-center justify-center p-4 m-4 rounded border border-yellow-200">
                        <p className="inline-flex sm:contents  xl:block">
                            برای اندروید کانکشن هوشمند بدون مشکل می باشد
                        </p>
                    </div>

                    <div className="text-yellow-900 bg-yellow-100 flex items-center justify-center p-4 m-4 rounded border border-yellow-200">
                        <p className="inline-flex sm:contents  xl:block">
                            قبل از مشاهده آموزش ها حتما در صورتی که Open Connect یا Cisco Any Connect را دارید حتما حذف و مجددا فقط از سایت دانلود و نصب کنید
                        </p>
                    </div>
                    ...
                    <div className=" w-full flex items-center justify-center">
                        <div className="w-[97%] border rounded mt-12 flex-col p-2 sm:w-full flex items-center justify-center border">
                            <Link href={"#"} className="w-full hover:bg-gray-100 items-center justify-center flex gap-2 border-b py-[10px] text-[18px] text-gray-600 ">
                                <TiTick className="text-2xl text-gray-700" />
                                <p className="display-fit">
                                پیشنهادی : برای مشاهده آموزش استفاده از کانکشن هوشمند اینجا کلیک کنید.
                                </p>
                            </Link>
                            <Link href={"#"} className="w-full hover:bg-gray-100 items-center justify-center flex gap-2 border-b py-[10px] text-[18px] text-gray-600">
                                <LiaHandPointer className="text-2xl text-gray-700" />
                                <p className="display-fit">
                                برای مشاهده آموزش استفاده از OpenConnect-VPN اینجا کلیک کنید.
                                </p>
                            </Link>
                            <Link href={"#"} className="w-full hover:bg-gray-100 items-center justify-center flex gap-2 border-b py-[10px] text-[18px] text-gray-600">
                                <LiaHandPointer className="text-2xl text-gray-700" />
                                <p className="display-fit">
                                برای مشاهده آموزش استفاده از CiscoAnyconnect اینجا کلیک کنید.
                                </p>
                            </Link>
                            <Link href={"#"} className="w-full hover:bg-gray-100 items-center justify-center flex gap-2 border-b py-[10px] text-[18px] text-gray-600">
                                <LiaHandPointer className="text-2xl text-gray-700" />
